  ...
  return (
    <div className="pb-20 pt-36">
        <div className="">
            ...
            fill="purple"
            />
            <Spotlight className="left-80 top-28 h-[60vh] w-[20vw]" fill="blue" />
        </div>
        ...
        <div className="flex justify-center relative my-20 z10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                ...
                words="Testing the transition effect"
                />

                <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg ld:text-2xl">
                    Hey there, I'm Tushar K Rao, a Full stack Web Developer based in the US.
                </p>
