...
const rightLists = ["Python", "NextJS", "PosgresQL"];
const rightmostLists = ["Django", "DynamoDB", "Redis"];
  ...
  return (
    ...
    >
      ...
      <div className={`${id==6} && flex justify-center h-full`}>
        ...
        {id === 4 && (
            <div className="flex gap-1 lg:gap-5 w-fit center -ml-20 lg:-right-2">
              {/* tech stack lists */}
